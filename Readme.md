...
curl -Ls https://download.newrelic.com/install/newrelic-cli/scripts/install.sh | bash && sudo NEW_RELIC_API_KEY=NRAK-VVIY17MXT8PMZHZO1TMV391KZD3 NEW_RELIC_ACCOUNT_ID=6977494 /usr/local/bin/newrelic install -n logs-integration
